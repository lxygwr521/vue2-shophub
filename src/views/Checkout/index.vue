...
const getCheckInfo = async ()=>{
   ...
   const item = checkInfo.value.find((item)=>item.isDefault===0)
...
<template>
  ...
  <!-- 切换地址 -->
  <el-dialog title="切换收货地址" width="30%" v-model='toggleFlag' center>
  <div class="addressWrapper">
    <div class="text item" :class='{active:item.id === curAddress.id}' v-for="item in checkInfo.userAddresses" @click='changeActive(item)'  :key="item.id">
      <ul>
